...
<html lang="en">
    <head>
        ...
        <title>Initialing Page</title>
    </head>

    <body>
    	<form action="/SampathBankWebPortal/InitializerController" method="get">
    		<input type="submit" value="Initialize The Database"/>
    	</form>
    	<a href="/SampathBankWebPortal/jsp/employee_hr_payroll_management/EHPM_HrRecruitmentOfficer_RecruitAnEmployee.jsp"><button>Do Not Initialize the Database</button></a>
