...
public class Head extends Employee {
	...
	public Head(int personId, Name name, Address address, String nic, Date dateOfBirth,
	...
	public Head(String firstName, String middleName, String lastName, String otherNames, String addStreet01,
